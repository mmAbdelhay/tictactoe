...
public class LosingSavedBase extends AnchorPane {
    ...
    public LosingSavedBase() {
        ...
        imageView0.setImage(new Image(getClass().getResource("../Images/loser.gif").toExternalForm()));
