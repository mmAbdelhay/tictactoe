...
public class DrawBase extends AnchorPane {
    ...
    public DrawBase() {
        ...
        imageView0.setLayoutX(308.0);
        imageView0.setLayoutY(150.0);
        imageView0.setImage(new Image(getClass().getResource("../Images/draw.gif").toExternalForm()));
    ...
    public static void changeScene(Button btn,Object obj){
