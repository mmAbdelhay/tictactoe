...
public class WinningPlayer2Base extends AnchorPane {
    ...
    public WinningPlayer2Base() {
        ...
        imageView0.setImage(new Image(getClass().getResource("../../Images/winner.gif").toExternalForm()));
